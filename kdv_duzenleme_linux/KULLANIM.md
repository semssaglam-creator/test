...
Aynı sekmedeki **Düzeltme Fişi** kartından, vergi dairesinin düzenlediği düzeltme
fişi formu Excel olarak alınır. Dosya, elde doldurulan formun düzenini korur; her
yıl **ayrı bir sayfaya** yazılır, çünkü formun başlığı yıl taşır.

Sayfa iki tablodan oluşur:

| Bölüm | İçerik |
|---|---|
| MÜKELLEF TARAFINDAN SÜRESİNDE BEYAN EDİLEN KDV DÖKÜMLERİ | *Beyan Verisi* sekmesindeki rakamlar |
| MÜKELLEF ADINA OLMASI GEREKEN KDV BEYANNAME DÖKÜMLERİ | Tespitler uygulandıktan ve devir zinciri yeniden kurulduktan sonraki rakamlar |

İkinci tablonun altına iki satır eklenir:

- **TARHI GEREKEN VERGİ** — yukarıdaki tarhiyat tablosunda bulunan
  **Re'sen Tarhı Gereken KDV** sütununun aynısıdır (olması gereken ödenecek KDV
  ile beyan edilenin farkının, yalnızca mükellef aleyhine olan yönü).
- **SONRAKİ DÖN DEV KDV UYUMSUZLUK TUTARI** — beyan edilen devir ile olması
  gereken devir arasındaki fark; fazla ve yersiz devredilen KDV'dir. Mükellef
  devri olması gerekenden az beyan etmişse bu satır eksi çıkar ve eksi işaretiyle
  yazılır.

Her iki tabloda da **incelemenin kapsamadığı aylar boş bırakılır**, sıfır
yazılmaz: fiş imzalanan bir belge olduğu için "beyan yok" ile "beyan sıfır"
ayrımı korunur. Yılın ay sayısını *Beyan Verisi* sekmesinden değiştirirsiniz.
